...
// ─── Register Refugee ─────────────────────────────────────────────────────────
export const registerRefugee = async (body) => {
  const { full_name, phone, email, password, family_number, need, selected_language, device_id } = body;
...
// ─── Login Refugee ────────────────────────────────────────────────────────────
export const loginRefugee = async ({ phone, email, password }) => {
