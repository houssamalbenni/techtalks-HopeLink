      ...
      <div className="globe-visual__inner">
        <div className="globe-visual__canvas">
          <svg viewBox="0 0 260 260" xmlns="http://www.w3.org/2000/svg">
            ...
            <circle cx="130" cy="130" r="5" fill="#4f7dff" opacity="0.9" />
            <circle cx="80" cy="95" r="4" fill="#7b5ea7" opacity="0.8" />
            <circle cx="170" cy="85" r="3.5" fill="#4f7dff" opacity="0.7" />
            <circle cx="155" cy="160" r="4" fill="#7b5ea7" opacity="0.8" />
            <circle cx="95" cy="165" r="3" fill="#4f7dff" opacity="0.6" />
            <circle cx="60" cy="140" r="3" fill="#a07ed4" opacity="0.7" />
            <circle cx="195" cy="125" r="3.5" fill="#4f7dff" opacity="0.7" />
            <circle cx="140" cy="75" r="3" fill="#7b5ea7" opacity="0.6" />
